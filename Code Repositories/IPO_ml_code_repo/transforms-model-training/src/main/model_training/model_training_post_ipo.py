...
from main.model_adapters.adapter import PostIPOModelAdapter
...
def train_model(training_df):
    ...
    all_numeric = NUMERIC_FEATURES + POST_IPO_NUMERIC
...
@transform(
    ...
    model_output=ModelOutput("/inmind.ai/Temporary Training Artifacts/Learning - Peter El Bikai/Final Project/code repos/models/ipo_post_ipo_model"),
)
def compute(training_data_input, model_output):
    ...
    foundry_model = PostIPOModelAdapter(model, feature_cols)
